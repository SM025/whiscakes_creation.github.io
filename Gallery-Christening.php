...
<html lang="en" dir="ltr">
	...
	<body>
		...
		<div class="gallery-section">
			...
			<h1>Christening and Minimalist Cakes</h1>
			<p>Whiscakes Creation's previous orders you might like.<br>Kindly message or indicate in payment section the dedications on the cake [Optional]</p>
			...
			<div class="gallery">
				...
				<?php
					galleryDisplay("cnm_cakes", $user_id); 
				?>
