...
<html>
    ...
    <body>
        ...
        <div class="banner-title"> 
            <h1>Create a moment with us.</h1>
                <a href="res-guidelines.html"><button class="btn">ORDER HERE</button></a>        
        </div>
            ...
            <div class="chat-box">
                ...
                <form method="post" action="php/sendChat.php">
                    <div class="chat-input">
                        ...
                        <input type="hidden" placeholder="Enter Message" name="user_id" value="<?php echo $_SESSION['user_id']; ?>" />
                        <input type="hidden" placeholder="Enter Message" name="user_type" value="<?php echo $_SESSION['user_type']; ?>" />
        ...
        <div class="banner1">
            <a href="res-our services.html"><h5 class="btn1">Our Services</h5></a>
            <a href="res-privacy policy.html"><h5 class="btn1">Privacy Policy</h5></a>
        </div>
