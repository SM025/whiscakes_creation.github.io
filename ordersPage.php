    ...
    <body>
        <div class="hero4">
            <div class="navigation">
                            ...
                            <i class="fa fa-close" onclick="closeMenu()"></i>
                                <ul>
                                  ...
                                  <!--  <li><a href="Guidelines1.html">Guidelines</a></li> -->
                                    ...
                                    <li><a href="ordersPage.php" style="color: #ddd;">Orders</a></li>
                ...
                <div id="note">
                    <h3>NOTE: (FOR PENDING ORDERS ONLY) If you want to cancel your order, please send message via gmail or scan this qr code.  <br></h3>
                    <img id="cancel1" src="images/cancel.png">
                    <h4>Email: :  whiscakes.creation@gmail.com</h4>
                </div>
