...
<html>
    ...
    <i class="fa fa-bars" style="font-size: 40px;" onclick="showMenu()"></i>
       ...
       <div class="privacy-policy">
           ...
           <h3>Do we collect any personal information?</h3>
           <p>The only personal information we collect is that which you signed up and submit your invoice form through our website. This information will not be used for any other purpose other than to provide you with a transaction receipt to ensure a complete and accurate record of your history and engagement with us.</p><br>
           <h3>What can you do if you have a complaint?</h3>
           <p>If you are not happy in respect to how we collect your personal information, you should firstly contact us via email or phone number.<br><br><b>Phone Number:</b>09999705956<br>
            <h4>contact us:</h4>
           <i class="fa fa-mobile-phone" style="font-size:15px"> 09999705952</i><br>
           <i class="fa fa-mobile-phone" style="font-size:15px"> 09999705952</i><br>
           <i class="fa fa-envelope">  whiscakes.creation@gmail.com</i>
           <h4>follow us:</h4>
